...
!\[virtual inmoov screenshot](http://myrobotlab.org/sites/default/files/users/user3images/Selection\_922.png)
...
MyRightPort=COMx | inside config/\\\_service\\\_6\\\_Arduino.config  
isRightHandActivated=True | inside config/skeleton\\\_rightHand.config  
